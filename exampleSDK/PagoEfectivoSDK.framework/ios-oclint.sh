...
xcodebuild -project "${PROJECT_NAME}.xcodeproj" -scheme PagoEfectivoSDK build | tee xcodebuild.log | xcpretty -r json-compilation-database -o compile_commands.json
